...
import styles from './footer-layout-10.module.scss';
...
// Component
/**
 * FooterLayout10 Component
 * 
 * The `FooterLayout10` component is a page footer component useful for easy site navigation.
 ...
 * />
 * 
 * @param { TFooterLayout10Props } props - The properties for configuring the FooterLayout10 component.
 * 
 * @returns { JSX.Element } - The FooterLayout10 component is being returned as a JSX element.
 */
export const FooterLayout10 = ( props: TFooterLayout10Props ): JSX.Element => {
  // #region - PROPS
  const {
    companyName,
    links,
