...
import styles from './footer-layout-3.module.scss';
...
// Component
/**
 * FooterLayout3 Component
 * 
 * The `FooterLayout3` component is a page footer component useful for easy site navigation.
 ...
 * />
 * 
 * @param { TFooterLayout3Props } props - The properties for configuring the FooterLayout3 component.
 * 
 * @returns { JSX.Element } - The FooterLayout3 component is being returned as a JSX element.
 */
export const FooterLayout3 = ( props: TFooterLayout3Props ): JSX.Element => {
  // #region - PROPS
  const {
    address,
    companyName,
