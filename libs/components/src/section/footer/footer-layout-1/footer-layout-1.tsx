...
import styles from './footer-layout-1.module.scss';
...
// Component
/**
 * FooterLayout1 Component
 * 
 * The `FooterLayout1` component is a page footer component useful for easy site navigation.
 ...
 * />
 * 
 * @param { TFooterLayout1Props } props - The properties for configuring the FooterLayout1 component.
 * 
 * @returns { JSX.Element } - The FooterLayout1 component is being returned as a JSX element.
 */
export const FooterLayout1 = ( props: TFooterLayout1Props ): JSX.Element => {
  // #region - PROPS
  const {
    companyName,
    links,
