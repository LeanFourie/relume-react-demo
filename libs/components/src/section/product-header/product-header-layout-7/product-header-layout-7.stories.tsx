...
// Story
export const ProductHeader7: StoryObj<typeof ProductHeaderLayout7> = {
  render: ( args: TProductHeaderLayout7Props ) => (
    <WindowProvider>
      <ProductHeaderLayout7 { ...args } />
    </WindowProvider>
  ),
  args: {
...
// Meta
const meta: Meta<typeof ProductHeaderLayout7> = {
  component: ProductHeaderLayout7,
  tags: ['autodocs'],
  argTypes: {
    badges: {
