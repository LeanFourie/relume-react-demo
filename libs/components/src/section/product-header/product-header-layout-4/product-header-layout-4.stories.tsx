...
// Story
export const ProductHeader4: StoryObj<typeof ProductHeaderLayout4> = {
  render: ( args: TProductHeaderLayout4Props ) => (
    <WindowProvider>
      <div style={{ padding: '0 0 80vh' }}>
        <ProductHeaderLayout4 { ...args } />
      </div>
    </WindowProvider>
  ),
  args: {
...
// Meta
const meta: Meta<typeof ProductHeaderLayout4> = {
  component: ProductHeaderLayout4,
  tags: ['autodocs'],
  argTypes: {
    badges: {
