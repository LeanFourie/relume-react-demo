...
// Story
export const ProductHeader8: StoryObj<typeof ProductHeaderLayout8> = {
  render: ( args: TProductHeaderLayout8Props ) => (
    <WindowProvider>
      <ProductHeaderLayout8 { ...args } />
    </WindowProvider>
  ),
  args: {
...
// Meta
const meta: Meta<typeof ProductHeaderLayout8> = {
  component: ProductHeaderLayout8,
  tags: ['autodocs'],
  argTypes: {
    badges: {
