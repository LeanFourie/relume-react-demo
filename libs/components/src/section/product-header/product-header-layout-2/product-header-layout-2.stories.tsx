...
// Story
export const ProductHeader2: StoryObj<typeof ProductHeaderLayout2> = {
  render: ( args: TProductHeaderLayout2Props ) => (
    <WindowProvider>
      <ProductHeaderLayout2 { ...args } />
    </WindowProvider>
  ),
  args: {
    ...
    images: [
      ...
      {
        alt: '',
        src: 'https://images.unsplash.com/photo-1682448741502-12511b055a98?q=80&w=2835&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      },
      {
        alt: '',
        src: 'https://images.unsplash.com/photo-1559962219-f52ccd86944e?q=80&w=2419&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      }
    ],
    name: 'Product name',
    onAddToCartClick: () => {},
...
// Meta
const meta: Meta<typeof ProductHeaderLayout2> = {
  component: ProductHeaderLayout2,
  tags: ['autodocs'],
  argTypes: {
    badges: {
