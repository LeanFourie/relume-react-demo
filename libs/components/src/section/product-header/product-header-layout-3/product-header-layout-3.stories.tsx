...
import type { TProductHeaderLayout3Props } from './product-header-layout-3.definitions';

// ----------------------------------------------------- //

// Story
export const ProductHeader3: StoryObj<typeof ProductHeaderLayout3> = {
  render: ( args: TProductHeaderLayout3Props ) => (
    <ProductHeaderLayout3 { ...args } />
  ),
  args: {
...
// Meta
const meta: Meta<typeof ProductHeaderLayout3> = {
  component: ProductHeaderLayout3,
  tags: ['autodocs'],
  argTypes: {
    badges: {
