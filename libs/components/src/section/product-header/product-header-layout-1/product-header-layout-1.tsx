...
import styles from './product-header-layout-1.module.scss';
...
} from './product-header-layout-1.definitions';

// Component
/**
 * ProductHeaderLayout1 Component
 * 
 * The `ProductHeaderLayout1` component description...
 * Composition...
 * 
 * @component
 * @example
 * <ProductHeaderLayout1
 ...
 * />
 * 
 * @param { TProductHeaderLayout1Props } props - The properties for configuring the ProductHeaderLayout1 component.
 * 
 * @returns { JSX.Element } - The ProductHeaderLayout1 component is being returned as a JSX element.
 */
export const ProductHeaderLayout1 = ( props: TProductHeaderLayout1Props ): JSX.Element => {
  // #region - PROPS
  const {
    badges,
    description,
  ...
  const {
    ...
    'returns',
    'shipping'
  ] as TProductHeaderLayout1Accordion[] );
  // #endregion
   ...
   */
  const accordions: {
    id: TProductHeaderLayout1Accordion;
    paragraph: string;
    title: string;
  }[] = [
    {
  ...
  const handleAccordionItemClick = (
    ...
    panelId: TProductHeaderLayout1Accordion
  ): void => {
    handleAccordionPanelClick(
      event,
      panelId,
