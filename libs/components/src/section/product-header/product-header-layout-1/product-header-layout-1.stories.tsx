...
import type { TProductHeaderLayout1Props } from './product-header-layout-1.definitions';

// ----------------------------------------------------- //

// Story
export const ProductHeader1: StoryObj<typeof ProductHeaderLayout1> = {
  render: ( args: TProductHeaderLayout1Props ) => (
    <ProductHeaderLayout1 { ...args } />
  ),
  args: {
...
// Meta
const meta: Meta<typeof ProductHeaderLayout1> = {
  component: ProductHeaderLayout1,
  tags: ['autodocs'],
  argTypes: {
    badges: {
