...
import styles from './product-header-layout-6.module.scss';
import {
  motion,
  useScroll,
  useTransform
...
// Component
/**
 * ProductHeaderLayout6 Component
 * 
 * The `ProductHeaderLayout6` component description...
 * Composition...
 * 
 * @component
 * @example
 * <ProductHeaderLayout6
 ...
 * />
 * 
 * @param { TProductHeaderLayout6Props } props - The properties for configuring the ProductHeaderLayout6 component.
 * 
 * @returns { JSX.Element } - The ProductHeaderLayout6 component is being returned as a JSX element.
 */
export const ProductHeaderLayout6 = ( props: TProductHeaderLayout6Props ): JSX.Element => {
  // #region - PROPS
  const {
    badges,
    description,
