...
import styles from './hero-layout-12.module.scss';
import {
  motion,
  useAnimationFrame,
  useMotionValue,
...
import type { THeroLayout12Props } from './hero-layout-12.definitions';
import type { MotionValue } from 'framer-motion';

// Component
/**
 * HeroLayout12 Component
 * 
 * The `HeroLayout12` component is a page hero component useful to introduce pages.
 ...
 * />
 * 
 * @param { THeroLayout12Props } props - The properties for configuring the HeroLayout12 component.
 * 
 * @returns { JSX.Element } - The HeroLayout12 component is being returned as a JSX element.
 */
export const HeroLayout12 = ( props: THeroLayout12Props ): JSX.Element => {
  // #region - PROPS
  const {
    actions,
    images,
  ...
  const generateImageGroup = ( type: 'odd' | 'even' ): JSX.Element => (
    <motion.div
      style={{ translateX: type === 'even' ? translateX.negative : translateX.positive }}
      className={`
