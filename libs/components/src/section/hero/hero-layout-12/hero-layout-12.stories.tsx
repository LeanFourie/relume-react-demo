...
// Story
export const HeroHeader78: StoryObj<typeof HeroLayout12> = {
  render: ( args: THeroLayout12Props ) => (
...
// Meta
const meta: Meta<typeof HeroLayout12> = {
  component: HeroLayout12,
  tags: ['autodocs'],
  argTypes: {
    actions: {
