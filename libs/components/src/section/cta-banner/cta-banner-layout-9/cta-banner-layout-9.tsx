// Packages & Modules
import styles from './cta-banner-layout-9.module.scss';
...
// Component
/**
 * CtaBannerLayout9 Component
 * 
 * The `CtaBannerLayout9` component is a banner section prompting users to navigate though the site.
 ...
 * />
 * 
 * @param { TCtaBannerLayout9Props } props - The properties for configuring the CtaBannerLayout9 component.
 * 
 * @returns { JSX.Element } - The CtaBannerLayout9 component is being returned as a JSX element.
 */
export const CtaBannerLayout9 = ( props: TCtaBannerLayout9Props ): JSX.Element => {
  // #region - PROPS
  const {
    links,
    tagline
      ...
      <div className={ styles[ `${ baseClass }__inner` ] }>
        ...
        <div className={ styles[ `${ baseClass }__links` ] }>
          ...
          <motion.div
            ...
            style={{
              left: `calc( 70vw + ${ _mousePosition.x * .15 }px )`,
          ...
          { links.map( ( link, index: number ) => (
            ...
            >
              ...
              <div className={ styles[ `${ baseClass }__link-label` ] }>
                <Text
                  className={ styles[ `${ baseClass }__link-label-index` ] }
                  fontWeight={ 'bold' }
                  renderAs={ 'span' }
